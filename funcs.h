...
{	
	if(value == 1){
		...
		if(pPior==0){
			maInicial = geraMatrizIndividuo(maInicial, piorInd);
			maInicial1 = geraMatrizIndividuo(maInicial1, piorInd);
			maInicial2 = geraMatrizIndividuo(maInicial2, piorInd);
	...
	if(value == 2){
		...
		if(pMelhor==0){
			maInicial = geraMatrizIndividuo(maInicial, melhorInd);
			maInicial1 = geraMatrizIndividuo(maInicial1, melhorInd);
			maInicial2 = geraMatrizIndividuo(maInicial2, melhorInd);
			maInicial = iniciPMatriz(20,maInicial);
			maInicial1 = iniciPMatriz(50,maInicial1);
			maInicial2 = iniciPMatriz(80,maInicial2);
			pMelhor=1;
